		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Suppliers",
									"targetURL": "#nlgasuniesuppliersupplier-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"nlgasuniesuppliersupplier-display": {
								"semanticObject": "nlgasuniesuppliersupplier",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=nl.gasunie.supplier.supplier",
									"url": sap.ui.require.toUrl("nl/gasunie/supplier/supplier")
								}
							}
						}
					}
