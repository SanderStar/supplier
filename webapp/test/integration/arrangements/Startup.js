sap.ui.define([
	"sap/ui/test/Opa5",
	"nl/gasunie/supplier/supplier/localService/mockserver",
	"sap/ui/model/odata/v2/ODataModel"
], function(Opa5, mockserver, ODataModel) {
	"use strict";

	return Opa5.extend("nl.gasunie.supplier.supplier.test.integration.arrangements.Startup", {
		...
		iStartMyApp : function (oOptionsParameter) {
			...
			this.iStartMyUIComponent({
				componentConfig: {
					name: "nl.gasunie.supplier.supplier",
					async: true
				},
				hash: oOptions.hash,
